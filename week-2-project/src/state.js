...
const Ex14 = function ({ base_list }) {
  ...
  return (
    <div>
      ...
      <button
        onClick={() => {
          /* update the state here */          const newList = items.slice();
          newList.push(base_list[idx]);
          setItems(newList);
          setIdx(idx + 1);
        }}
      >
